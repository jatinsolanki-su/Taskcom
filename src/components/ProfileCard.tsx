...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(99, 102, 241, 0.4)',
      ...
      '--sunpillar-1': 'hsl(217, 91%, 60%)',
      '--sunpillar-2': 'hsl(250, 95%, 70%)',
      '--sunpillar-3': 'hsl(270, 91%, 65%)',
      '--sunpillar-4': 'hsl(190, 95%, 70%)',
      '--sunpillar-5': 'hsl(230, 91%, 65%)',
      '--sunpillar-6': 'hsl(290, 95%, 70%)',
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          className="grid relative overflow-hidden shadow-2xl"
          style={{
            height: '70svh',
            maxHeight: '480px',
            aspectRatio: '0.718',
            ...
            boxShadow:
              'rgba(0, 0, 0, 0.5) calc((var(--pointer-from-left) * 10px) - 5px) calc((var(--pointer-from-top) * 20px) - 10px) 25px -5px',
          ...
          >
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div
                      className="rounded-full overflow-hidden border border-white/10 flex-shrink-0 bg-indigo-600/30 flex items-center justify-center text-white/90 font-mono text-sm font-bold"
                    ...
                    <div className="flex flex-col items-start gap-0.5">
                      ...
                      <div className="text-[10px] text-white/70 leading-none flex items-center gap-1 mt-0.5">
                  ...
                  <button
                    className="border border-white/10 bg-white/5 hover:bg-white/10 rounded-md px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/30 hover:-translate-y-px"
                    onClick={handleContactClick}
                    style={{ pointerEvents: 'auto', display: 'block', borderRadius: '6px' }}
                    type="button"
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '2.5em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-bold m-0 tracking-tight"
                  style={{
                    fontSize: 'min(4.5svh, 2.2em)',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #9fa0ff)',
                ...
                <p
                  className="font-medium whitespace-nowrap mx-auto w-min tracking-widest uppercase font-mono mt-1"
                  style={{
                    fontSize: '11px',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #8183ff)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
